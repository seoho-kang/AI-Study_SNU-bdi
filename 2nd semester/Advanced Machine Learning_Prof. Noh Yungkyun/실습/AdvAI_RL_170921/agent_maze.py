...
class RL_agent(object):
    ...
    def __init__(self):
        ...
        self.env.redraw_arrows(self.fig, self.vec_policy)
    ...
    def learn_TD0_iterate(self, num_iteration = 10000000, thr_converge = 1e-3, prt = False):
    ...
    # learn action values using Q learning
    ...
    # iterate learn_Q_step
    def learn_Q_iterate(self, num_iteration = 10000000, thr_converge = 1e-3, prt = False):
    ...
    def on_key(self, event):
        dict_key = {'right':0,'up':1,'left':2,'down':3}
        dict_dir = {0: 'right', 1: 'up', 2: 'left', 3:'down'}
...
if __name__ == '__main__':
    ...
    print "rewards of maze: {}".format(agent.env.rewards)
